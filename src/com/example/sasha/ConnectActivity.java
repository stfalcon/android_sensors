...
public class ConnectActivity extends Activity {
  private static final String DEBUG_TAG = ConnectActivity.class.getName();
  ...
  private Handler mServerHandler = new MessageHandler(ConnectActivity.this) {
    @Override
  ...
  private Handler mClientHandler = new MessageHandler(ConnectActivity.this) {
    @Override
    public void onMessage(String type, JSONObject message) {
